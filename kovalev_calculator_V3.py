...
print(' - вычитание(2)')
print(' - умножение(3)')
print(' - целочисленное деление(4)')
print(' - взятие остатка(5)')
print(' - возведение в степень(6)')
print(' - квадратный корень числа(7)')
print(' - переводить из любой системы счисления в десятичную(8)')
print(' - анализ числа(9)')
...
while otvet == 'Да':
    ...
    if oper == 1 or oper == 2 or oper == 3 or oper == 4 or oper == 5 or oper == 6:
        num2 = float(input('Введите второе число: '))
        while oper == 4 and num2 == 0:
        ...
        if anl == 1:
            ...
            while num1 != 10:
                ...
                summ += p
                num1 //= 10
            print('Сумма цифр числа равна', answ)
        elif anl == 4:
            simple = True
            k = 2
            while k < num1:
            ...
            while k < num1 and square != True:
                ...
                k += 1
            if square:
                print('Это число является квадратом')
            else:
            ...
            while k < num1 and cube != True:
                ...
                k += 1
            if cube:
                print('Это число является кубом')
            else:
                print('Это число не является кубом')
